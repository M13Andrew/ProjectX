...
class TestTwo:
    ...
    def test_three(self):
        ...
        plan_by_sells_qty_button = wait.until(ec.presence_of_element_located((By.XPATH, "//label[@class='ant-radio-button-wrapper'][1]")))
        ...
        last_seven_days_button = wait.until(ec.presence_of_element_located((By.XPATH, '//div[@class="ant-tabs-tab"][2]')))
        ...
        last_thirty_days_button = wait.until(ec.presence_of_element_located((By.XPATH, '//div[@class="ant-tabs-tab"][2]')))
        ...
        last_current_date_button = wait.until(ec.presence_of_element_located((By.XPATH, '//div[@class="ant-tabs-tab"][1]')))
